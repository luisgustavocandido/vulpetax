-- Garantir tabela customers e coluna customer_id em client_partners (idempotente)
-- Use se a migração 0028 não tiver sido aplicada ou o banco estiver sem a coluna.
