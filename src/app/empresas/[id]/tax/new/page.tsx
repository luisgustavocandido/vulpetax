...
export default function NewTaxFormPageEmpresas() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await res.json();
      router.push(`${BASE_PATH}/${id}/tax/${data.taxFormId}`);
      router.refresh();
    } catch (err) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">Crie um novo formulário TAX para esta empresa</p>
      </div>
